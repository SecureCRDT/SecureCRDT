...
public class EverGrowingSetCrdtClient extends CrdtClient {
    public SetPlayerState[] responses;

    public EverGrowingSetCrdtClient(Client client) {
        super(client);
    }
    ...
    public void update(String input) throws IOException, InvalidSecretValue {
        ...
        for (int i = 0;i < 3; i ++){
            ...
            IntProtocolMessage protocolRequest = new IntProtocolMessage(EVERGROWINGSET_PROTOCOL_NAME, message);
    ...
    public SetPlayerState[] propagate() throws IOException, InterruptedException {
        ...
        for (int i = 0;i < 3; i ++){
            IntProtocolMessage protocolRequest = new IntProtocolMessage(EVERGROWINGSET_PROTOCOL_NAME, new byte[]{});
    ...
    public void merge() throws IOException, InvalidSecretValue {
        ...
        for (int i = 0;i < 3; i ++){
            IntProtocolMessage protocolRequest = new IntProtocolMessage(EVERGROWINGSET_PROTOCOL_NAME, incomingStates[i].serialize());
