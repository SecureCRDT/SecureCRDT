...
public class MaxvalueCrdtClient extends CrdtClient {
    RegisterPlayerState[] responses = new RegisterPlayerState[3];

    public MaxvalueCrdtClient(Client client) {
        super(client);
    }
    ...
    public void update(String input) throws IOException, InvalidSecretValue {
        ...
        for (int i = 0;i < 3; i ++){
            ...
            IntProtocolMessage protocolRequest = new IntProtocolMessage(MAXVALUE_PROTOCOL_NAME, message);
    ...
    public int query(String input) throws IOException, InterruptedException {
        ...
        for (int i = 0;i < 3; i ++){
            IntProtocolMessage protocolRequest = new IntProtocolMessage(MAXVALUE_PROTOCOL_NAME, new byte[]{});
